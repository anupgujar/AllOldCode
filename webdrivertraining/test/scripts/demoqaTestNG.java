...
public class demoqaTestNG {
	...
	public void demoqaTest() throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='subjectsInput']")));		
		subject.click();
	...
	public void beforeMethod() throws InterruptedException {
		...
		wait = new WebDriverWait(driver, Duration.ofSeconds(20),Duration.ofMillis(250));
